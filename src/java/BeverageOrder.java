 ...
 */
@WebServlet(urlPatterns = {"/BeverageOrder"})
public class BeverageOrder extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            HttpSession session=request.getSession();
                ...
                if(request.getParameter("coldcheck")!=null){
                int q1=Integer.parseInt(request.getParameter("q1"));
                String i1=request.getParameter("coldcheck");
               ...
               if(request.getParameter("icecheck")!=null){ 
               int q2=Integer.parseInt(request.getParameter("q2"));
               String i2=request.getParameter("icecheck");
               ...
               if(request.getParameter("cappcheck")!=null){
               int q3=Integer.parseInt(request.getParameter("q3"));
                String i3=request.getParameter("cappcheck");
               ...
               if(request.getParameter("mochacheck")!=null){
               int q4=Integer.parseInt(request.getParameter("q4"));
                String i4=request.getParameter("mochacheck");
                ...
                if(request.getParameter("freshcheck")!=null){
                int q5=Integer.parseInt(request.getParameter("q5"));
                String i5=request.getParameter("freshcheck");
               ...
               if(request.getParameter("hotchocheck")!=null){
                int q6=Integer.parseInt(request.getParameter("q6"));
                String i6=request.getParameter("hotchocheck");
            ...
            if(request.getParameter("mangocheck")!=null){
                int q7=Integer.parseInt(request.getParameter("q7"));
                String i7=request.getParameter("mangocheck");
