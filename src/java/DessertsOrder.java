...
@WebServlet(urlPatterns = {"/DessertsOrder"})
public class DessertsOrder extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
            /* TODO output your page here. You may use following sample code. */
             HttpSession session=request.getSession();
                ...
                if(request.getParameter("tiracheck")!=null){
                int q1=Integer.parseInt(request.getParameter("q1"));
                String i1=request.getParameter("tiracheck");
               ...
               if(request.getParameter("coffeecheck")!=null){ 
               int q2=Integer.parseInt(request.getParameter("q2"));
               String i2=request.getParameter("coffeecheck");
               ...
               if(request.getParameter("chococheck")!=null){
               int q3=Integer.parseInt(request.getParameter("q3"));
                String i3=request.getParameter("chococheck");
               ...
               if(request.getParameter("rascheck")!=null){
               int q4=Integer.parseInt(request.getParameter("q4"));
                String i4=request.getParameter("rascheck");
                ...
                if(request.getParameter("rasmacheck")!=null){
                int q5=Integer.parseInt(request.getParameter("q5"));
                String i5=request.getParameter("rasmacheck");
               ...
               if(request.getParameter("icecheck")!=null){
                ...
                String i6=request.getParameter("icecheck");
            ...
            if(request.getParameter("cococheck")!=null){
                int q7=Integer.parseInt(request.getParameter("q7"));
                String i7=request.getParameter("cococheck");
