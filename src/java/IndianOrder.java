 ...
 */
@WebServlet(urlPatterns = {"/IndianOrder"})
public class IndianOrder extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            HttpSession session=request.getSession();
                ...
                if(request.getParameter("chicbcheck")!=null){
                int q1=Integer.parseInt(request.getParameter("q1"));
                String i1=request.getParameter("chicbcheck");
               ...
               String i2=request.getParameter("mealscheck");
               ...
               if(request.getParameter("vegkcheck")!=null){
               int q3=Integer.parseInt(request.getParameter("q3"));
                String i3=request.getParameter("vegkcheck");
               ...
               if(request.getParameter("butccheck")!=null){
               int q4=Integer.parseInt(request.getParameter("q4"));
                String i4=request.getParameter("butccheck");
                ...
                if(request.getParameter("breadcheck")!=null){
                int q5=Integer.parseInt(request.getParameter("q5"));
                String i5=request.getParameter("breadcheck");
               ...
               if(request.getParameter("kadaicheck")!=null){
                int q6=Integer.parseInt(request.getParameter("q6"));
                String i6=request.getParameter("kadaicheck");
            ...
            if(request.getParameter("fishcheck")!=null){
                int q7=Integer.parseInt(request.getParameter("q7"));
                String i7=request.getParameter("fishcheck");
