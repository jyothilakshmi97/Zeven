...
@WebServlet(urlPatterns = {"/ItalianOrder"})
public class ItalianOrder extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            HttpSession session=request.getSession();
                ...
                if(request.getParameter("lascheck")!=null){
                int q1=Integer.parseInt(request.getParameter("q1"));
                String i1=request.getParameter("lascheck");
               ...
               if(request.getParameter("pascheck")!=null){ 
               int q2=Integer.parseInt(request.getParameter("q2"));
               String i2=request.getParameter("pascheck");
               ...
               if(request.getParameter("pasredcheck")!=null){
               int q3=Integer.parseInt(request.getParameter("q3"));
                String i3=request.getParameter("pasredcheck");
               ...
               if(request.getParameter("saltcheck")!=null){
               int q4=Integer.parseInt(request.getParameter("q4"));
                String i4=request.getParameter("saltcheck");
                ...
                if(request.getParameter("osscheck")!=null){
                int q5=Integer.parseInt(request.getParameter("q5"));
                String i5=request.getParameter("osscheck");
               ...
               if(request.getParameter("pizzacheck")!=null){
                int q6=Integer.parseInt(request.getParameter("q6"));
                String i6=request.getParameter("pizzacheck");
            ...
            if(request.getParameter("aracheck")!=null){
                int q7=Integer.parseInt(request.getParameter("q7"));
                String i7=request.getParameter("aracheck");
