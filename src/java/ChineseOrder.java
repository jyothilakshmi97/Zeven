        ...
        try (PrintWriter out = response.getWriter()) {
            /* TODO output your page here. You may use following sample code. */
             ...
             HttpSession session=request.getSession();
                ...
                if(request.getParameter("chocheck")!=null){
                int q1=Integer.parseInt(request.getParameter("q1"));
                String i1=request.getParameter("chocheck");
               ...
               if(request.getParameter("friedcheck")!=null){ 
               int q2=Integer.parseInt(request.getParameter("q2"));
               String i2=request.getParameter("friedcheck");
               ...
               if(request.getParameter("creamcheck")!=null){
               int q3=Integer.parseInt(request.getParameter("q3"));
                String i3=request.getParameter("creamcheck");
               ...
               if(request.getParameter("dragcheck")!=null){
               int q4=Integer.parseInt(request.getParameter("q4"));
                String i4=request.getParameter("dragcheck");
                ...
                if(request.getParameter("chillycheck")!=null){
                int q5=Integer.parseInt(request.getParameter("q5"));
                String i5=request.getParameter("chillycheck");
               ...
               if(request.getParameter("chickpotcheck")!=null){
                int q6=Integer.parseInt(request.getParameter("q6"));
                String i6=request.getParameter("chickpotcheck");
            ...
            if(request.getParameter("mixcheck")!=null){
                int q7=Integer.parseInt(request.getParameter("q7"));
                String i7=request.getParameter("mixcheck");
